...
<title>お問い合わせ | 医療・介護、葬儀、身元保証までトータルサポート | 株式会社はな採用サイト</title>
...
<meta name="author" content="お問い合わせ | 医療・介護、葬儀、身元保証までトータルサポート | 株式会社はな採用サイト">
<meta property="og:title" content="お問い合わせ | 医療・介護、葬儀、身元保証までトータルサポート | 株式会社はな採用サイト">
      ...
      <section class="top_message brand_section1" >
        <div class="title_box">
          ...
          <div class="moblock">
            ...
            <div class="title_box_img text-center">
              <h1>お問い合わせ<span><img src="../images/ptitle/contact.svg" alt=""></span></h1>
            </div>
          </div>
            </div>
          </div>
        ...
        <section id="content_title" class="form">
          <div class="section_cover">
            <div class="container">
              <p>
                ご質問・お問い合わせは下記のフォームからお願い致します。<br>
                <span>※</span>印は必須となります。
              </p>
            </div>
          </div>
            ...
            <div class="container">
              ...
              <div class="form_wrapperwrapper">
                ...
                <div class="form-area">
                  ...
                  <form class="" action="c_send.php" method="post">
                      <table>
